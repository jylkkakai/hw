...
NVDLA_WINOGRAD_ENABLE := 1
NVDLA_BATCH_ENABLE := 1
NVDLA_SDP_LUT_ENABLE := 1
NVDLA_SDP_BS_ENABLE := 1
NVDLA_SDP_BN_ENABLE := 1
NVDLA_SDP_EW_ENABLE := 1
NVDLA_RUBIK_ENABLE := 1
NVDLA_RUBIK_CONTRACT_ENABLE := 1
NVDLA_RUBIK_RESHAPE_ENABLE := 1
NVDLA_PDP_ENABLE := 1
NVDLA_CDP_ENABLE := 1
...
NVDLA_CBUF_BANK_DEPTH := 128
NVDLA_SDP_BS_THROUGHPUT := 4
NVDLA_SDP_BN_THROUGHPUT := 4
NVDLA_SDP_EW_THROUGHPUT := 1
...
NVDLA_SECONDARY_MEMIF_MAX_BURST_LENGTH := 4
...
NVDLA_VMOD_SDP_ERDMA_OUTPUT_THROUGHPUT := 4
NVDLA_VMOD_CDP_RDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_PDP_RDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_SDP_MRDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_SDP_BRDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_SDP_NRDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_SDP_ERDMA_OUTPUT_THROUGHPUT_USE := 2
NVDLA_VMOD_CDP_RDMA_LATENCY_FIFO_DEPTH := 128
NVDLA_VMOD_PDP_RDMA_LATENCY_FIFO_DEPTH := 128
NVDLA_VMOD_SDP_MRDMA_LATENCY_FIFO_DEPTH := 128
NVDLA_VMOD_SDP_BRDMA_LATENCY_FIFO_DEPTH := 128
NVDLA_VMOD_SDP_NRDMA_LATENCY_FIFO_DEPTH := 128
NVDLA_VMOD_SDP_ERDMA_LATENCY_FIFO_DEPTH := 128
...
NVDLA_CBUF_BANK_DEPTH_LOG2 := 7
NVDLA_CBUF_DEPTH_LOG2 := 12
